...
import static bibliotheque.gestion.Gestion.hmloc;
...
public class Exemplaire {
    ...
    public Lecteur lecteurActuel(){
        if(enLocation()) return hmloc.get(this);
        return null;
    }
    ...
    public boolean enLocation(){
        if(hmloc.isEmpty()) return false;
        //la location en cours est la dernière de la liste
        if(hmloc.get(this)!=null) return true;
        return false;
    }
